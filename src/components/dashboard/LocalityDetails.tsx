  ...
  const handleEditClick = async () => {
    ...
    try {
      ...
      const formData = {
        ...
        qt_residencias: (freshData.qt_residencias ?? data.qt_residencias || 0).toString(),
        qt_comercio: (freshData.qt_comercio ?? data.qt_comercio || 0).toString(),
        qt_terreno_baldio: (freshData.qt_terreno_baldio ?? data.qt_terreno_baldio || 0).toString(),
        qt_pe: (freshData.qt_pe ?? data.qt_pe || 0).toString(),
        qt_outros: (freshData.qt_outros ?? data.qt_outros || 0).toString(),
        qt_total: (freshData.qt_total ?? data.qt_total || 0).toString(),
        tratamento_focal: (freshData.tratamento_focal ?? data.tratamento_focal || 0).toString(),
        tratamento_perifocal: (freshData.tratamento_perifocal ?? data.tratamento_perifocal || 0).toString(),
        inspecionados: (freshData.inspections ?? data.inspections || 0).toString(),
        amostras_coletadas: (freshData.amostras_coletadas ?? data.amostras_coletadas || 0).toString(),
        recusa: (freshData.recusa ?? data.recusa || 0).toString(),
        fechadas: (freshData.fechadas ?? data.fechadas || 0).toString(),
        recuperadas: (freshData.recuperadas ?? data.recuperadas || 0).toString(),
        a1: (freshData.a1 ?? data.a1 || 0).toString(),
        a2: (freshData.a2 ?? data.a2 || 0).toString(),
        b: (freshData.b ?? data.b || 0).toString(),
        c: (freshData.c ?? data.c || 0).toString(),
        d1: (freshData.d1 ?? data.d1 || 0).toString(),
        d2: (freshData.d2 ?? data.d2 || 0).toString(),
        e: (freshData.e ?? data.e || 0).toString(),
        depositos_eliminados: (freshData.deposits_eliminated ?? data.depositsEliminated || 0).toString(),
        larvicida: freshData.larvicida || data.larvicida || '',
        quantidade_larvicida: (freshData.quantidade_larvicida ?? data.quantidade_larvicida || 0).toString(),
        quantidade_depositos_tratados: (freshData.quantidade_depositos_tratados ?? data.quantidade_depositos_tratados || 0).toString(),
        adulticida: freshData.adulticida || data.adulticida || '',
        quantidade_cargas: (freshData.quantidade_cargas ?? data.quantidade_cargas || 0).toString(),
        total_tec_saude: (freshData.total_tec_saude ?? data.total_tec_saude || 0).toString(),
        total_dias_trabalhados: (freshData.total_dias_trabalhados ?? data.total_dias_trabalhados || 0).toString(),
